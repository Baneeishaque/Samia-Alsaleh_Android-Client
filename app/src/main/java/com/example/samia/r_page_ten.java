...
public class r_page_ten extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_r_page_ten);
        ...
        buttonBuy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ActivityUtils.startActivity(activityContext, r_page_eleven.class);
            }
        });
